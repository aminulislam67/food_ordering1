...
if(isset($submit))
{
	$rs=mysqli_query($con,"select * from student where login='$loginid' and pass='$pass'");
...
echo "<h1 class='text-center bg-danger'>Welcome to Online Exam</h1>";
  ...
  <tr>
    ...
    <td width="93%" valign="bottom" bordercolor="#0000FF"> <a href="sublist.php" class="style4">Are You Ready? </a></td>
  </tr>
